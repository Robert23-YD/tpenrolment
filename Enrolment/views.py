...
def register(request):
    if request.method == 'POST':
        ...
        new_stu = Student(s_name=s_name, s_fathername=s_fathername, s_mothername=s_mothername, s_addr=s_addr,
                          s_school=s_school, s_email=s_email, s_gender=s_gender, s_class=s_class)
        new_stu.save()
